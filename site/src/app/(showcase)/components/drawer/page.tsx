                ...
                >
                      ...
                      {navSections.map((section, idx) => (
                        <div
                          ...
                          style={{
                            paddingTop:
                              idx > 0
                                ? theme.components.drawer.sectionPadding[
                                    density
                                  ].y
                                : "0",
                          }}
                        >
                          {section.title && (
                            <h3
                              ...
                              style={{
                                marginBottom:
                                  theme.components.drawer.titleMarginBottom[
                                    density
                                  ],
                              }}
                            >
                          ...
                          <nav
                            style={{
                              ...
                              gap: theme.components.drawer.itemSpacing[density],
                            }}
                          >
                            {section.items.map((item) => (
                              <button
                                ...
                                style={{
                                  paddingLeft:
                                    theme.components.drawer.itemPadding[density]
                                      .x,
                                  paddingRight:
                                    theme.components.drawer.itemPadding[density]
                                      .x,
                                  ...
                                  paddingBottom:
                                    theme.components.drawer.itemPadding[density]
                                      .y,
                                  fontSize: theme.components.drawer.fontSize,
                                  borderRadius:
                                    theme.components.drawer.borderRadius,
                                }}
                              >
                                {item.icon}
                                {item.label}
                  ...
                  >
                    ...
                    <p className="text-gray-600 text-sm mb-4">
                      ...
                      side. Use controls below to toggle options.
                    </p>
                    <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                      ...
                      <p className="text-xs text-gray-600">
                        This shows the Drawer component with your content side
                        by side.
                      </p>
                    </div>
                  </div>
