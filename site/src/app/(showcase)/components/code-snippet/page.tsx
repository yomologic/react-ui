          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              <div className="p-6 bg-linear-to-br from-gray-50 to-gray-100 rounded-lg border border-gray-200">
                <CodeSnippet
                  code={sampleCode[language as keyof typeof sampleCode]}
                  language={language}
                />
              </div>
            ...
            <div className="space-y-3 pt-2 border-t border-gray-200">
              <div className="text-sm text-gray-600">
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-700">
                  <li>Syntax highlighting with VS Code Dark+ theme</li>
            ...
            <table className="w-full">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                ...
                <tr>
                  ...
                  <td className="px-6 py-4 text-sm text-gray-700">
                    Programming language for syntax highlighting (tsx,
                    javascript, python, css, json, etc.)
                  </td>
                </tr>
              </tbody>
            </table>
