            ...
            <div className="relative">
              <div className="p-6 bg-linear-to-br from-gray-50 to-gray-100 rounded-lg border border-gray-200">
                ...
                >
                  {showHeader && (
                    <DialogHeader>
                      {showTitle && <DialogTitle>Dialog Title</DialogTitle>}
                      {showDescription && (
                        <DialogDescription>
                  ...
                  <DialogContent>
                    <p className="text-sm text-gray-700">
                      ...
                      any content here including forms, text, images, or other
                      components.
                    </p>
                  </DialogContent>
                  {showFooter && (
            ...
            <table className="w-full">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                ...
                <tr>
                  ...
                  <td className="px-6 py-4 text-sm text-gray-700">
                    Dialog content (Header, Content, Footer components)
                  </td>
                </tr>
              </tbody>
            </table>
              ...
              <table className="w-full">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  ...
                  <tr>
                    ...
                    <td className="px-6 py-4 text-sm text-gray-700">
                      Semantic h2 heading for the dialog title
                    </td>
                    <td className="px-6 py-4 text-sm text-gray-600 font-mono">
                  ...
                  <tr>
                    ...
                    <td className="px-6 py-4 text-sm text-gray-700">
                      Muted text for dialog descriptions or subtitles
                    </td>
                    <td className="px-6 py-4 text-sm text-gray-600 font-mono">
